...
function DSBDA() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Data Science and Big Data Analytics</div>
      <ReactPlayer url="https://www.youtube.com/watch?v=xQLkZIH-Pdc&pp=ygUpIGRhdGEgc2NpZW5jZSBhbmQgYmlnIGRhdGEgYW5hbHl0aWNzIHNwcHXSBwkJsgkBhyohjO8%3D" controls autoPlay />
