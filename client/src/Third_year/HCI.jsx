...
function HCI() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Human-Computer Interaction</div>
      <ReactPlayer url="https://www.youtube.com/watch?v=Pf_zJ2oRMEU&list=PLYwpaL_SFmcDz_8-pygbcNvNF0DEwKoIL" controls autoPlay />
