...
function ML() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Machine Learning</div>
      <ReactPlayer url="https://www.youtube.com/watch?v=0SN_3ab1PrE&list=PL-qGkizijcBmn3azuDrNbaBlHOTzJf4pM" controls autoPlay />
