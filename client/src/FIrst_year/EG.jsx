...
function EG() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Engineering Graphics</div>
      <ReactPlayer url="https://youtu.be/bqFssA9qWBw?si=o2FkaPQprWfpCaHv" controls autoPlay />
