...
function EM() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Engineering Mechanics</div>
      <ReactPlayer url="https://youtu.be/Vb1aMHC1_BM?si=TAvGsHBrO7K0Ckum" controls autoPlay />
