...
function PPS() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Programming and Problem Solving</div>
      <ReactPlayer url="https://youtu.be/LZWB-cM_arE?si=Kg29pK_LibinWNK_" controls autoPlay />
