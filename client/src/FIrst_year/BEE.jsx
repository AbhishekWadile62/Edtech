...
function BEE() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Basic Electrical Engineering</div>
      <ReactPlayer url=" https://youtu.be/Vd2UJiIPbag?si=0_gXfp7YKIXgq4GR" controls autoPlay />
