...
function BXE() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Basic Electronics Engineering</div>
      <ReactPlayer url="https://youtu.be/y-kU_L-8thI?si=4QUFhXFicwRB1Fgc" controls autoPlay />
