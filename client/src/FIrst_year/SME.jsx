...
function SME() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Systems in Mechanical Engineering</div>
      <ReactPlayer url="https://youtu.be/xrCijZGDv44?si=z4mZauDPxn8yf9Ss" controls autoPlay />
