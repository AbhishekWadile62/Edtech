...
function CH() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Engineering Chemistry</div>
      <ReactPlayer url="https://youtu.be/B2mseqYyvIA?si=Jo9KsuUhwS2FciJf" controls autoPlay />
