...
function M1() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Engineering Mathematics 1 </div>
      <ReactPlayer url="https://youtu.be/bQ_B9cHBYfQ?si=2OMih0hm9DtgrQDW" controls autoPlay />
