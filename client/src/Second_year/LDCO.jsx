...
function LDCO() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Logic Design and Computer Organisation</div>
      <ReactPlayer url="https://www.youtube.com/watch?v=L9X7XXfHYdU&list=PLxCzCOWd7aiHMonh3G6QNKq53C6oNXGrX" controls autoPlay />
