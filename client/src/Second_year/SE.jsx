...
function SE() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Software Engineering</div>
      <ReactPlayer url="https://www.youtube.com/watch?v=ZaXc0UcBvuU&pp=ygUZc29mdHdhcmUgZW5naW5lZXJpbmcgc3BwdQ%3D%3D" controls autoPlay />
