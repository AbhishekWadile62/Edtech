...
function PA() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>Processor Architecture</div>
      <ReactPlayer url="https://www.youtube.com/watch?v=_vPDDc7U6zw&list=PLQ-nEJNYlEV1UcMIKw1TvLLzb8cIqqlYN" controls autoPlay />
