...
function BT() {
  return (
    <div className='justify-center items-center gap-10 flex flex-col w-[100vw] h-[100vh]'>
      ...
      <div className='text-3xl uppercase font-semibold'>BlockChain Technology </div>
      <ReactPlayer url="https://youtube.com/playlist?list=PLPIwNooIb9vgfXs-QkRYqqZbDXX-yLf59&si=ujyeHDf9xraeYD9f" controls autoPlay />
